...
- Makers
of the STEP and STEP+ for the DallasTINI board (a must see for embedded
...
- nice but a bit expensive, may be just what some one needs though.<br>
      ...
      <span style="font-style: italic; color: rgb(255, 102, 0);">(Page Not Found)</span>
      <a href="http://home.nc.rr.com/rtpmicro/">RTP Micros</a>
- 2 very nice Phillips '552 boards with all the trimmings. Nice price
too.<br>
...
(SoC) design house<br>
      ...
      <a href="http://www.jungo.com/">jungo.com</a>
- Jungo makes USB,
PCI and ISA driver development tools, including WinDriver and
KernelDriver that automate&nbsp;and simplify the development of
device
drivers for the Windows, Linux, Solaris, and VxWorks
...
system over USB port in a standard DIL40 package<br>
      ...
      <p><span style="color: rgb(255, 102, 0); font-style: italic;">(Page Not Found)</span> <a href="http://www4.tpg.com.au/users/void/bkauler">Goofee</a>
- Graphical Object Orientation, very different, very interesting. <b>NOTE</b>:
Link updated Jan 6,2001<br>
...
- a portable, open source, mini Real Time Kernel<br>
      ...
      <p> <a href="http://www.geocities.com/pdmtr">PC
...
- interesting site for electronic information.<br>
      ...
      <p> <a href="http://www.egnite.de/ethernut/">Ethernut</a>
- a
...
what not to do.</p>
      ...
      <p><b>T6963 controlled LCD panels </b>(includes
...
made a better mouse trap... please email me and let me know.</p>
      ...
      <table border="0" cellpadding="0" cellspacing="2" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="http://www.webring.org/cgi-bin/webring?ring=80x51;list">The
8051 Web Ring </a> <img src="images/x51chip.jpg" alt="webring icon" align="middle" height="63" width="81"> </td>
          ...
          <tr>
            ...
            <img style="border: 0px solid ; width: 88px; height: 31px;" src="http://jigsaw.w3.org/css-validator/images/vcss" alt="Valid CSS!"></a></td>
          ...
          <tr>
            ...
            <a href="http://sourceforge.net/tracker/?func=add&amp;group_id=599&amp;atid=536150">Webmaster</a></td>

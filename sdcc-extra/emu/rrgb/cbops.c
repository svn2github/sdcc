...

{
   ...
   case  4: rlc(h); break;
   case  5: rlc(l); break;
   case  6: tstates+=8;val=fetch(addr);rlc(val);store(addr,val);break;
   case  7: rlc(a); break;
   case  8: rrc(b); break;
   case  9: rrc(c); break;
   case 10: rrc(d); break;
   ...
   case 12: rrc(h); break;
   case 13: rrc(l); break;
   case 14: tstates+=8;val=fetch(addr);rrc(val);store(addr,val);break;
   case 15: rrc(a); break;
   ...
   case 0x16: tstates+=8;val=fetch(addr);rl(val);store(addr,val);break;
   ...
   case 0x1e: tstates+=8;val=fetch(addr);rr(val);store(addr,val);break;
   ...
   case 0x26: tstates+=8;val=fetch(addr);sla(val);store(addr,val);break;
   ...
   case 0x2e: tstates+=8;val=fetch(addr);sra(val);store(addr,val);break;
   case 0x2f: sra(a); break;
   case 0x30: nswap(b); break;
   case 0x31: nswap(c); break;
   case 0x32: nswap(d); break;
   case 0x33: nswap(e); break;
   case 0x34: nswap(h); break;
   case 0x35: nswap(l); break;
   case 0x36: tstates+=8;val=fetch(addr);nswap(val);store(addr,val);break;
   case 0x37: nswap(a); break;
   ...
   case 0x3e: tstates+=8;val=fetch(addr);srl(val);store(addr,val);break;
   case 0x3f: srl(a); break;
      ...
      case 0x46: tstates+=8;val=fetch(addr);bit(n,val);store(addr,val);break;
      ...
      case 0x86: tstates+=8;val=fetch(addr);res(n,val);store(addr,val);break;
      ...
      case 0xc6: tstates+=8;val=fetch(addr);set(n,val);store(addr,val);break;

...
ifneq ($(CROSSCOMPILING), 1)
	$(MAKE) $(MAKEJOBFLAGS) -C src/sdcc/support/regression SDCC_HOME=$(BUILDDIR) SDCC_EXTRA_DIR=$(TOPDIR)/src/sdcc-extra test-host test-z80 test-mcs51 test-mcs51-stack-auto test-mcs51-large test-ds390
endif

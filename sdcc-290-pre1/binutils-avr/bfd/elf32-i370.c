...
/* This file is based on a preliminary PowerPC ELF ABI.  
   But its been hackked on for the instruction 360/370 architectures.
...
//     case BFD_RELOC_32:			i370_reloc = R_I370_ADDR32;	break;
    case BFD_RELOC_32:			i370_reloc = R_I370_ADDR31;	break;
    case BFD_RELOC_16:			i370_reloc = R_I370_ADDR16;	break;
//    case BFD_RELOC_LO16:		i370_reloc = R_I370_ADDR16_LO;	break;
//    case BFD_RELOC_HI16:		i370_reloc = R_I370_ADDR16_HI;	break;
//     case BFD_RELOC_HI16_S:		i370_reloc = R_I370_ADDR16_HA;	break;
//     case BFD_RELOC_16_GOTOFF:	i370_reloc = R_I370_GOT16;	break;
//     case BFD_RELOC_LO16_GOTOFF:	i370_reloc = R_I370_GOT16_LO;	break;
//     case BFD_RELOC_HI16_GOTOFF:	i370_reloc = R_I370_GOT16_HI;	break;
//     case BFD_RELOC_HI16_S_GOTOFF:	i370_reloc = R_I370_GOT16_HA;	break;
//     case BFD_RELOC_24_PLT_PCREL:	i370_reloc = R_I370_PLTREL24;	break;
    case BFD_RELOC_32_PCREL:		i370_reloc = R_I370_REL31;	break; 
//     case BFD_RELOC_32_PLTOFF:	i370_reloc = R_I370_PLT32;	break;
//     case BFD_RELOC_32_PLT_PCREL:	i370_reloc = R_I370_PLTREL32;	break;
//     case BFD_RELOC_LO16_PLTOFF:	i370_reloc = R_I370_PLT16_LO;	break;
//     case BFD_RELOC_HI16_PLTOFF:	i370_reloc = R_I370_PLT16_HI;	break;
//     case BFD_RELOC_HI16_S_PLTOFF:	i370_reloc = R_I370_PLT16_HA;	break;
//     case BFD_RELOC_GPREL16:		i370_reloc = R_I370_SDAREL16;	break;
//     case BFD_RELOC_32_BASEREL:	i370_reloc = R_I370_SECTOFF;	break;
//     case BFD_RELOC_LO16_BASEREL:	i370_reloc = R_I370_SECTOFF_LO;	break;
//     case BFD_RELOC_HI16_BASEREL:	i370_reloc = R_I370_SECTOFF_HI;	break;
//     case BFD_RELOC_HI16_S_BASEREL:	i370_reloc = R_I370_SECTOFF_HA;	break;
...
// 
static boolean i370_elf_create_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *));

static boolean i370_elf_section_from_shdr PARAMS ((bfd *,
						  Elf32_Internal_Shdr *,
						  char *));
static boolean i370_elf_fake_sections
...
/* XXX most of the code above is trash.  but we need to hack something for
 * .rela.text in order to avoid a dump
 */
...
#ifdef DEBUG
  fprintf (stderr, "i370_elf_adjust_dynindx called, h->dynindx = %d, *cp = %d\n", h->dynindx, *cp);
#endif
...
#define ELF_MACHINE_CODE	EM_I370
...
int i370_noop() {return 1;}

/* we need to define these at least as no-ops to link glibc ld.so */

#define elf_backend_add_symbol_hook		i370_noop
#define elf_backend_finish_dynamic_symbol	i370_noop
#define elf_backend_additional_program_headers	i370_noop
#define elf_backend_modify_segment_map		i370_noop

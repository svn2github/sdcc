...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6812\m6812.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\M12ADR.OBJ  $(OUTPUTDIR)\M12EXT.OBJ  $(OUTPUTDIR)\M12MCH.OBJ  \
		 $(OUTPUTDIR)\M12PST.OBJ 
...
$(OUTPUTDIR)\M12EXT.OBJ:	..\..\..\AS6812\M12EXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\M12EXT.obj ..\..\..\AS6812\M12EXT.C

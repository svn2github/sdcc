...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6805\m6805.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\M05ADR.OBJ  $(OUTPUTDIR)\M05EXT.OBJ  $(OUTPUTDIR)\M05MCH.OBJ  \
		 $(OUTPUTDIR)\M05PST.OBJ 
...
$(OUTPUTDIR)\M05EXT.OBJ:	..\..\..\AS6805\M05EXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\M05EXT.obj ..\..\..\AS6805\M05EXT.C

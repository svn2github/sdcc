...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\ASH8\h8.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\H8ADR.OBJ  $(OUTPUTDIR)\H8EXT.OBJ  $(OUTPUTDIR)\H8MCH.OBJ  \
		 $(OUTPUTDIR)\H8PST.OBJ 
...
$(OUTPUTDIR)\H8EXT.OBJ:	..\..\..\ASH8\H8EXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\H8EXT.obj ..\..\..\ASH8\H8EXT.C

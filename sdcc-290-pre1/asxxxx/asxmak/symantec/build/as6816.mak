...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6816\m6816.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\M16ADR.OBJ  $(OUTPUTDIR)\M16EXT.OBJ  $(OUTPUTDIR)\M16MCH.OBJ  \
		 $(OUTPUTDIR)\M16PST.OBJ 
...
$(OUTPUTDIR)\M16EXT.OBJ:	..\..\..\AS6816\M16EXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\M16EXT.obj ..\..\..\AS6816\M16EXT.C

...
static reloc_howto_type elf_avr_howto_table[] =
{
  ...
  HOWTO (R_AVR_32,		/* type */
	 ...
	 0xffffffff,		/* dst_mask */
	 false),		/* pcrel_offset */
  /* An 7 bit PC relative relocation */
  ...
  /* An 13 bit PC relative relocation */
  ...
  HOWTO (R_AVR_HH8_LDI_PM,		/* type */
	 ...
	 0xffff,		/* dst_mask */
	 false),		/* pcrel_offset */
  /* A low 8 bit absolute relocation of anegative 24 bit
     program memory address. For SUBI command */

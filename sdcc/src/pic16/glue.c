...
pic16glue ()
{
  ...
  struct dbuf_s vBuf;
    ...
    if (mainf && IFFUNC_HASBODY(mainf->type) && pic16->xinst && !has_xinst_config)
      {
        fprintf(stderr, "WARNING: The target device seems to support XINST and no #pragma config XINST={ON|OFF} was found.\n");
        fprintf(stderr, "         The code generated by SDCC does not work when XINST is enabled (possibly by default).\n");

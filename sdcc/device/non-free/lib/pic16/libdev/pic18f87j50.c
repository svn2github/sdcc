/*
 * This definitions of the PIC18F87J50 MCU.
 *
 * This file is part of the GNU PIC library for SDCC, originally
 * created by Molnar Karoly <molnarkaroly@users.sf.net> 2013.
 *
 * This file is generated automatically by the cinc2h.pl, 2013-01-13 11:07:51 UTC.
 *
...
__at(0x0F40) __sfr PMSTAT;

__at(0x0F40) __sfr PMSTATL;
__at(0x0F40) volatile __PMSTATLbits_t PMSTATLbits;

__at(0x0F41) __sfr PMSTATH;
__at(0x0F41) volatile __PMSTATHbits_t PMSTATHbits;

__at(0x0F42) __sfr PMEL;
__at(0x0F42) volatile __PMELbits_t PMELbits;

__at(0x0F42) __sfr PMEN;

__at(0x0F43) __sfr PMEH;
__at(0x0F43) volatile __PMEHbits_t PMEHbits;

__at(0x0F44) __sfr PMDIN2;

__at(0x0F44) __sfr PMDIN2L;

__at(0x0F45) __sfr PMDIN2H;

__at(0x0F46) __sfr PMDOUT2;

__at(0x0F46) __sfr PMDOUT2L;

__at(0x0F47) __sfr PMDOUT2H;

__at(0x0F48) __sfr PMMODE;

__at(0x0F48) __sfr PMMODEL;
__at(0x0F48) volatile __PMMODELbits_t PMMODELbits;

__at(0x0F49) __sfr PMMODEH;
__at(0x0F49) volatile __PMMODEHbits_t PMMODEHbits;

__at(0x0F4A) __sfr PMCON;

__at(0x0F4A) __sfr PMCONL;
__at(0x0F4A) volatile __PMCONLbits_t PMCONLbits;

__at(0x0F4B) __sfr PMCONH;
__at(0x0F4B) volatile __PMCONHbits_t PMCONHbits;

__at(0x0F4C) __sfr UEP0;
__at(0x0F4C) volatile __UEP0bits_t UEP0bits;

__at(0x0F4D) __sfr UEP1;
__at(0x0F4D) volatile __UEP1bits_t UEP1bits;

__at(0x0F4E) __sfr UEP2;
__at(0x0F4E) volatile __UEP2bits_t UEP2bits;

__at(0x0F4F) __sfr UEP3;
__at(0x0F4F) volatile __UEP3bits_t UEP3bits;

__at(0x0F50) __sfr UEP4;
__at(0x0F50) volatile __UEP4bits_t UEP4bits;

__at(0x0F51) __sfr UEP5;
__at(0x0F51) volatile __UEP5bits_t UEP5bits;

__at(0x0F52) __sfr UEP6;
__at(0x0F52) volatile __UEP6bits_t UEP6bits;

__at(0x0F53) __sfr UEP7;
__at(0x0F53) volatile __UEP7bits_t UEP7bits;

__at(0x0F54) __sfr UEP8;
__at(0x0F54) volatile __UEP8bits_t UEP8bits;

__at(0x0F55) __sfr UEP9;
__at(0x0F55) volatile __UEP9bits_t UEP9bits;

__at(0x0F56) __sfr UEP10;
__at(0x0F56) volatile __UEP10bits_t UEP10bits;

__at(0x0F57) __sfr UEP11;
__at(0x0F57) volatile __UEP11bits_t UEP11bits;

__at(0x0F58) __sfr UEP12;
__at(0x0F58) volatile __UEP12bits_t UEP12bits;

__at(0x0F59) __sfr UEP13;
__at(0x0F59) volatile __UEP13bits_t UEP13bits;

__at(0x0F5A) __sfr UEP14;
__at(0x0F5A) volatile __UEP14bits_t UEP14bits;

__at(0x0F5B) __sfr UEP15;
__at(0x0F5B) volatile __UEP15bits_t UEP15bits;

__at(0x0F5C) __sfr UIE;
__at(0x0F5C) volatile __UIEbits_t UIEbits;

__at(0x0F5D) __sfr UEIE;
__at(0x0F5D) volatile __UEIEbits_t UEIEbits;

__at(0x0F5E) __sfr UADDR;
__at(0x0F5E) volatile __UADDRbits_t UADDRbits;

__at(0x0F5F) __sfr UCFG;
__at(0x0F5F) volatile __UCFGbits_t UCFGbits;
...
__at(0x0F66) __sfr PMDIN1;

__at(0x0F66) __sfr PMDIN1L;

__at(0x0F67) __sfr PMDIN1H;

__at(0x0F68) __sfr PMADDR;

__at(0x0F68) __sfr PMADDRL;

__at(0x0F68) __sfr PMDOUT1;

__at(0x0F68) __sfr PMDOUT1L;

__at(0x0F69) __sfr PMADDRH;
__at(0x0F69) volatile __PMADDRHbits_t PMADDRHbits;

__at(0x0F69) __sfr PMDOUT1H;

__at(0x0F6A) __sfr CMSTAT;
__at(0x0F6A) volatile __CMSTATbits_t CMSTATbits;

__at(0x0F6A) __sfr CMSTATUS;
__at(0x0F6A) volatile __CMSTATUSbits_t CMSTATUSbits;
...
__at(0x0F6E) __sfr SSP2MSK;
__at(0x0F6E) volatile __SSP2MSKbits_t SSP2MSKbits;
...
__at(0x0F77) __sfr CVRCON;
__at(0x0F77) volatile __CVRCONbits_t CVRCONbits;
...
__at(0x0FB1) __sfr CCP3CON;
__at(0x0FB1) volatile __CCP3CONbits_t CCP3CONbits;

__at(0x0FB1) __sfr ECCP3CON;
__at(0x0FB1) volatile __ECCP3CONbits_t ECCP3CONbits;

__at(0x0FB2) __sfr CCPR3;

__at(0x0FB2) __sfr CCPR3L;
__at(0x0FB2) __sfr16 CCPR3w;

__at(0x0FB3) __sfr CCPR3H;

__at(0x0FB4) __sfr ECCP3DEL;
__at(0x0FB4) volatile __ECCP3DELbits_t ECCP3DELbits;

__at(0x0FB5) __sfr ECCP3AS;
__at(0x0FB5) volatile __ECCP3ASbits_t ECCP3ASbits;

__at(0x0FB6) __sfr CCP2CON;
__at(0x0FB6) volatile __CCP2CONbits_t CCP2CONbits;

__at(0x0FB6) __sfr ECCP2CON;
__at(0x0FB6) volatile __ECCP2CONbits_t ECCP2CONbits;

__at(0x0FB7) __sfr CCPR2;

__at(0x0FB7) __sfr CCPR2L;
__at(0x0FB7) __sfr16 CCPR2w;

__at(0x0FB8) __sfr CCPR2H;

__at(0x0FB9) __sfr ECCP2DEL;
__at(0x0FB9) volatile __ECCP2DELbits_t ECCP2DELbits;

__at(0x0FBA) __sfr ECCP2AS;
__at(0x0FBA) volatile __ECCP2ASbits_t ECCP2ASbits;
...
__at(0x0FC1) __sfr ANCON0;
__at(0x0FC1) volatile __ANCON0bits_t ANCON0bits;

__at(0x0FC2) __sfr ADCON0;
__at(0x0FC2) volatile __ADCON0bits_t ADCON0bits;

__at(0x0FC2) __sfr ANCON1;
__at(0x0FC2) volatile __ANCON1bits_t ANCON1bits;
...
__at(0x0FCB) __sfr MEMCON;
__at(0x0FCB) volatile __MEMCONbits_t MEMCONbits;

__at(0x0FCB) __sfr PR2;

__at(0x0FCC) __sfr PADCFG1;
__at(0x0FCC) volatile __PADCFG1bits_t PADCFG1bits;

__at(0x0FCC) __sfr TMR2;

__at(0x0FCD) __sfr ODCON3;
__at(0x0FCD) volatile __ODCON3bits_t ODCON3bits;

__at(0x0FCD) __sfr T1CON;
__at(0x0FCD) volatile __T1CONbits_t T1CONbits;

__at(0x0FCE) __sfr ODCON2;
__at(0x0FCE) volatile __ODCON2bits_t ODCON2bits;

__at(0x0FCE) __sfr TMR1;

__at(0x0FCE) __sfr TMR1L;

__at(0x0FCF) __sfr ODCON1;
__at(0x0FCF) volatile __ODCON1bits_t ODCON1bits;
...
__at(0x0FD3) __sfr REFOCON;
__at(0x0FD3) volatile __REFOCONbits_t REFOCONbits;

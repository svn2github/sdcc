/*
 * This definitions of the PIC18F45J10 MCU.
 *
...
__at(0x0F85) __sfr SSP2CON2;
__at(0x0F85) volatile __SSP2CON2bits_t SSP2CON2bits;

__at(0x0F86) __sfr SSP2CON1;
__at(0x0F86) volatile __SSP2CON1bits_t SSP2CON1bits;

__at(0x0F87) __sfr SSP2STAT;
__at(0x0F87) volatile __SSP2STATbits_t SSP2STATbits;

__at(0x0F88) __sfr SSP2ADD;

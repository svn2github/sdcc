/*
 * pic18f43k22.c - device specific definitions
 *
...
__sfr __at (0xF3B) ANSELD;
volatile __ANSELDbits_t __at (0xF3B) ANSELDbits;

__sfr __at (0xF3C) ANSELE;
volatile __ANSELEbits_t __at (0xF3C) ANSELEbits;

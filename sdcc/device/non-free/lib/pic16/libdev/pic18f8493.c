/*
 * This definitions of the PIC18F8493 MCU.
 *
 * This file is part of the GNU PIC library for SDCC, originally
 * created by Molnar Karoly <molnarkaroly@users.sf.net> 2013.
 *
 * This file is generated automatically by the cinc2h.pl, 2013-01-13 11:08:15 UTC.
 *
...
__at(0x0F58) __sfr LCDPS;
__at(0x0F58) volatile __LCDPSbits_t LCDPSbits;

__at(0x0F59) __sfr LCDCON;
__at(0x0F59) volatile __LCDCONbits_t LCDCONbits;

__at(0x0F5A) __sfr LCDSE0;
__at(0x0F5A) volatile __LCDSE0bits_t LCDSE0bits;

__at(0x0F5B) __sfr LCDSE1;
__at(0x0F5B) volatile __LCDSE1bits_t LCDSE1bits;

__at(0x0F5C) __sfr LCDSE2;
__at(0x0F5C) volatile __LCDSE2bits_t LCDSE2bits;

__at(0x0F5D) __sfr LCDSE3;
__at(0x0F5D) volatile __LCDSE3bits_t LCDSE3bits;

__at(0x0F5E) __sfr LCDSE4;
__at(0x0F5E) volatile __LCDSE4bits_t LCDSE4bits;

__at(0x0F5F) __sfr LCDSE5;
__at(0x0F5F) volatile __LCDSE5bits_t LCDSE5bits;

__at(0x0F60) __sfr LCDDATA0;
__at(0x0F60) volatile __LCDDATA0bits_t LCDDATA0bits;

__at(0x0F61) __sfr LCDDATA1;
__at(0x0F61) volatile __LCDDATA1bits_t LCDDATA1bits;

__at(0x0F62) __sfr LCDDATA2;
__at(0x0F62) volatile __LCDDATA2bits_t LCDDATA2bits;

__at(0x0F63) __sfr LCDDATA3;
__at(0x0F63) volatile __LCDDATA3bits_t LCDDATA3bits;

__at(0x0F64) __sfr LCDDATA4;
__at(0x0F64) volatile __LCDDATA4bits_t LCDDATA4bits;

__at(0x0F65) __sfr LCDDATA5;
__at(0x0F65) volatile __LCDDATA5bits_t LCDDATA5bits;

__at(0x0F66) __sfr LCDDATA6;
__at(0x0F66) volatile __LCDDATA6bits_t LCDDATA6bits;

__at(0x0F67) __sfr LCDDATA7;
__at(0x0F67) volatile __LCDDATA7bits_t LCDDATA7bits;

__at(0x0F68) __sfr LCDDATA8;
__at(0x0F68) volatile __LCDDATA8bits_t LCDDATA8bits;

__at(0x0F69) __sfr LCDDATA9;
__at(0x0F69) volatile __LCDDATA9bits_t LCDDATA9bits;

__at(0x0F6A) __sfr LCDDATA10;
__at(0x0F6A) volatile __LCDDATA10bits_t LCDDATA10bits;
...
__at(0x0F70) __sfr LCDDATA11;
__at(0x0F70) volatile __LCDDATA11bits_t LCDDATA11bits;

__at(0x0F71) __sfr LCDDATA12;
__at(0x0F71) volatile __LCDDATA12bits_t LCDDATA12bits;

__at(0x0F72) __sfr LCDDATA13;
__at(0x0F72) volatile __LCDDATA13bits_t LCDDATA13bits;

__at(0x0F73) __sfr LCDDATA14;
__at(0x0F73) volatile __LCDDATA14bits_t LCDDATA14bits;

__at(0x0F74) __sfr LCDDATA15;
__at(0x0F74) volatile __LCDDATA15bits_t LCDDATA15bits;

__at(0x0F75) __sfr LCDDATA16;
__at(0x0F75) volatile __LCDDATA16bits_t LCDDATA16bits;

__at(0x0F76) __sfr LCDDATA17;
__at(0x0F76) volatile __LCDDATA17bits_t LCDDATA17bits;

__at(0x0F77) __sfr LCDDATA18;
__at(0x0F77) volatile __LCDDATA18bits_t LCDDATA18bits;

__at(0x0F78) __sfr LCDDATA19;
__at(0x0F78) volatile __LCDDATA19bits_t LCDDATA19bits;

__at(0x0F79) __sfr LCDDATA20;
__at(0x0F79) volatile __LCDDATA20bits_t LCDDATA20bits;

__at(0x0F7A) __sfr LCDDATA21;
__at(0x0F7A) volatile __LCDDATA21bits_t LCDDATA21bits;

__at(0x0F7B) __sfr LCDDATA22;
__at(0x0F7B) volatile __LCDDATA22bits_t LCDDATA22bits;

__at(0x0F7C) __sfr LCDDATA23;
__at(0x0F7C) volatile __LCDDATA23bits_t LCDDATA23bits;

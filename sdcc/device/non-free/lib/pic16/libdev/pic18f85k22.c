/*
 * This definitions of the PIC18F85K22 MCU.
 *
...
__at(0x0F26) __sfr MEMCON;
__at(0x0F26) volatile __MEMCONbits_t MEMCONbits;
...
__at(0x0F66) __sfr SSP2CON2;
__at(0x0F66) volatile __SSP2CON2bits_t SSP2CON2bits;

__at(0x0F67) __sfr SSP2CON1;
__at(0x0F67) volatile __SSP2CON1bits_t SSP2CON1bits;

__at(0x0F68) __sfr SSP2STAT;
__at(0x0F68) volatile __SSP2STATbits_t SSP2STATbits;

__at(0x0F69) __sfr SSP2ADD;

__at(0x0F69) __sfr SSP2MSK;
__at(0x0F69) volatile __SSP2MSKbits_t SSP2MSKbits;

__at(0x0F6A) __sfr SSP2BUF;

__at(0x0F6B) __sfr T4CON;
__at(0x0F6B) volatile __T4CONbits_t T4CONbits;

__at(0x0F6C) __sfr PR4;

__at(0x0F6D) __sfr TMR4;

__at(0x0F6E) __sfr CCP7CON;
__at(0x0F6E) volatile __CCP7CONbits_t CCP7CONbits;

__at(0x0F6F) __sfr CCPR7;

__at(0x0F6F) __sfr CCPR7L;
__at(0x0F6F) __sfr16 CCPR7w;

__at(0x0F70) __sfr CCPR7H;

__at(0x0F71) __sfr CCP6CON;
__at(0x0F71) volatile __CCP6CONbits_t CCP6CONbits;

__at(0x0F72) __sfr CCPR6;

__at(0x0F72) __sfr CCPR6L;
__at(0x0F72) __sfr16 CCPR6w;

__at(0x0F73) __sfr CCPR6H;

__at(0x0F74) __sfr CCP5CON;
__at(0x0F74) volatile __CCP5CONbits_t CCP5CONbits;

__at(0x0F75) __sfr CCPR5;

__at(0x0F75) __sfr CCPR5L;
__at(0x0F75) __sfr16 CCPR5w;

__at(0x0F76) __sfr CCPR5H;

__at(0x0F77) __sfr CCP4CON;
__at(0x0F77) volatile __CCP4CONbits_t CCP4CONbits;

__at(0x0F78) __sfr CCPR4;

__at(0x0F78) __sfr CCPR4L;
__at(0x0F78) __sfr16 CCPR4w;

__at(0x0F79) __sfr CCPR4H;

__at(0x0F7A) __sfr T5GCON;
__at(0x0F7A) volatile __T5GCONbits_t T5GCONbits;

__at(0x0F7B) __sfr T5CON;
__at(0x0F7B) volatile __T5CONbits_t T5CONbits;

__at(0x0F7C) __sfr TMR5;

__at(0x0F7C) __sfr TMR5L;

__at(0x0F7D) __sfr TMR5H;

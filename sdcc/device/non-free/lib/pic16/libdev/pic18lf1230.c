/*
 * This definitions of the PIC18LF1230 MCU.
 *
...
__at(0x0F82) __sfr OVDCONS;
__at(0x0F82) volatile __OVDCONSbits_t OVDCONSbits;

__at(0x0F83) __sfr OVDCOND;
__at(0x0F83) volatile __OVDCONDbits_t OVDCONDbits;

__at(0x0F84) __sfr DTCON;
__at(0x0F84) volatile __DTCONbits_t DTCONbits;

__at(0x0F85) __sfr PWMCON1;
__at(0x0F85) volatile __PWMCON1bits_t PWMCON1bits;

__at(0x0F86) __sfr PWMCON0;
__at(0x0F86) volatile __PWMCON0bits_t PWMCON0bits;

__at(0x0F87) __sfr SEVTCMPH;

__at(0x0F88) __sfr SEVTCMPL;
...
__at(0x0F8B) __sfr FLTCONFIG;
__at(0x0F8B) volatile __FLTCONFIGbits_t FLTCONFIGbits;

__at(0x0F8C) __sfr PDC2H;

__at(0x0F8D) __sfr PDC2L;

__at(0x0F8E) __sfr PDC1H;

__at(0x0F8F) __sfr PDC1L;

__at(0x0F90) __sfr PDC0H;

__at(0x0F91) __sfr PDC0L;
...
__at(0x0F95) __sfr PTPERH;

__at(0x0F96) __sfr PTPERL;

__at(0x0F97) __sfr PTMRH;

__at(0x0F98) __sfr PTMRL;

__at(0x0F99) __sfr PTCON1;
__at(0x0F99) volatile __PTCON1bits_t PTCON1bits;

__at(0x0F9A) __sfr PTCON0;
__at(0x0F9A) volatile __PTCON0bits_t PTCON0bits;

...
__at(0x0F5E) __sfr ANSELD;
__at(0x0F5E) volatile __ANSELDbits_t ANSELDbits;

__at(0x0F5F) __sfr ANSELE;
__at(0x0F5F) volatile __ANSELEbits_t ANSELEbits;

/*
 * This definitions of the PIC16F688 MCU.
 *
...
__at(0x0011) __sfr BAUDCTL;
__at(0x0011) volatile __BAUDCTLbits_t BAUDCTLbits;

__at(0x0012) __sfr SPBRGH;

__at(0x0013) __sfr SPBRG;

__at(0x0014) __sfr RCREG;

__at(0x0015) __sfr TXREG;

__at(0x0016) __sfr TXSTA;
__at(0x0016) volatile __TXSTAbits_t TXSTAbits;

__at(0x0017) __sfr RCSTA;
__at(0x0017) volatile __RCSTAbits_t RCSTAbits;
...
__at(0x0097) __sfr EEDATH;

__at(0x0098) __sfr EEADRH;

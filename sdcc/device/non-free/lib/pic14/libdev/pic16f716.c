/*
 * This definitions of the PIC16F716 MCU.
 *
...
__at(0x0006) __sfr DATACCP;
__at(0x0006) volatile __DATACCPbits_t DATACCPbits;
...
__at(0x0018) __sfr PWM1CON;
__at(0x0018) volatile __PWM1CONbits_t PWM1CONbits;

__at(0x0019) __sfr ECCPAS;
__at(0x0019) volatile __ECCPASbits_t ECCPASbits;
...
__at(0x0086) __sfr TRISCP;
__at(0x0086) volatile __TRISCPbits_t TRISCPbits;

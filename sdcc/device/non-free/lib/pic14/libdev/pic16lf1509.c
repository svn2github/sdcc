/*
 * This definitions of the PIC16LF1509 MCU.
 *
 * This file is part of the GNU PIC library for SDCC, originally
 * created by Molnar Karoly <molnarkaroly@users.sf.net> 2016.
 *
 * This file is generated automatically by the cinc2h.pl, 2016-01-09 15:09:15 UTC.
 *
...
__at(0x0F20) __sfr CLC3CON;
__at(0x0F20) volatile __CLC3CONbits_t CLC3CONbits;

__at(0x0F21) __sfr CLC3POL;
__at(0x0F21) volatile __CLC3POLbits_t CLC3POLbits;

__at(0x0F22) __sfr CLC3SEL0;
__at(0x0F22) volatile __CLC3SEL0bits_t CLC3SEL0bits;

__at(0x0F23) __sfr CLC3SEL1;
__at(0x0F23) volatile __CLC3SEL1bits_t CLC3SEL1bits;

__at(0x0F24) __sfr CLC3GLS0;
__at(0x0F24) volatile __CLC3GLS0bits_t CLC3GLS0bits;

__at(0x0F25) __sfr CLC3GLS1;
__at(0x0F25) volatile __CLC3GLS1bits_t CLC3GLS1bits;

__at(0x0F26) __sfr CLC3GLS2;
__at(0x0F26) volatile __CLC3GLS2bits_t CLC3GLS2bits;

__at(0x0F27) __sfr CLC3GLS3;
__at(0x0F27) volatile __CLC3GLS3bits_t CLC3GLS3bits;

__at(0x0F28) __sfr CLC4CON;
__at(0x0F28) volatile __CLC4CONbits_t CLC4CONbits;

__at(0x0F29) __sfr CLC4POL;
__at(0x0F29) volatile __CLC4POLbits_t CLC4POLbits;

__at(0x0F2A) __sfr CLC4SEL0;
__at(0x0F2A) volatile __CLC4SEL0bits_t CLC4SEL0bits;

__at(0x0F2B) __sfr CLC4SEL1;
__at(0x0F2B) volatile __CLC4SEL1bits_t CLC4SEL1bits;

__at(0x0F2C) __sfr CLC4GLS0;
__at(0x0F2C) volatile __CLC4GLS0bits_t CLC4GLS0bits;

__at(0x0F2D) __sfr CLC4GLS1;
__at(0x0F2D) volatile __CLC4GLS1bits_t CLC4GLS1bits;

__at(0x0F2E) __sfr CLC4GLS2;
__at(0x0F2E) volatile __CLC4GLS2bits_t CLC4GLS2bits;

__at(0x0F2F) __sfr CLC4GLS3;
__at(0x0F2F) volatile __CLC4GLS3bits_t CLC4GLS3bits;

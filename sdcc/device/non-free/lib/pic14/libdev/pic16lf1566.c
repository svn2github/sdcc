/*
 * This definitions of the PIC16LF1566 MCU.
 *
...
__at(0x0218) __sfr SSPLVL;
__at(0x0218) volatile __SSPLVLbits_t SSPLVLbits;
...
__at(0x0391) __sfr IOCBP;
__at(0x0391) volatile __IOCBPbits_t IOCBPbits;

__at(0x0392) __sfr IOCBN;
__at(0x0392) volatile __IOCBNbits_t IOCBNbits;

__at(0x0393) __sfr IOCBF;
__at(0x0393) volatile __IOCBFbits_t IOCBFbits;
...
__at(0x061D) __sfr PWMTMRS;
__at(0x061D) volatile __PWMTMRSbits_t PWMTMRSbits;

__at(0x061E) __sfr PWM1AOE;
__at(0x061E) volatile __PWM1AOEbits_t PWM1AOEbits;

__at(0x061F) __sfr PWM2AOE;
__at(0x061F) volatile __PWM2AOEbits_t PWM2AOEbits;

__at(0x0691) __sfr ADCTX;
__at(0x0691) volatile __ADCTXbits_t ADCTXbits;

__at(0x0692) __sfr AAD1TX;

__at(0x0692) __sfr AAD1TX0;
__at(0x0692) volatile __AAD1TX0bits_t AAD1TX0bits;

__at(0x0692) __sfr AD1TX;

__at(0x0692) __sfr AD1TX0;
__at(0x0692) volatile __AD1TX0bits_t AD1TX0bits;

__at(0x0693) __sfr AAD1TX1;
__at(0x0693) volatile __AAD1TX1bits_t AAD1TX1bits;

__at(0x0693) __sfr AD1TX1;
__at(0x0693) volatile __AD1TX1bits_t AD1TX1bits;

__at(0x0694) __sfr AAD2TX;

__at(0x0694) __sfr AAD2TX0;
__at(0x0694) volatile __AAD2TX0bits_t AAD2TX0bits;

__at(0x0694) __sfr AD2TX;

__at(0x0694) __sfr AD2TX0;
__at(0x0694) volatile __AD2TX0bits_t AD2TX0bits;

__at(0x0695) __sfr AAD2TX1;
__at(0x0695) volatile __AAD2TX1bits_t AAD2TX1bits;

__at(0x0695) __sfr AD2TX1;
__at(0x0695) volatile __AD2TX1bits_t AD2TX1bits;
...
__at(0x071E) __sfr AAD1CH0;
__at(0x071E) volatile __AAD1CH0bits_t AAD1CH0bits;

__at(0x071E) __sfr AD1CH;

__at(0x071E) __sfr AD1CH0;
__at(0x071E) volatile __AD1CH0bits_t AD1CH0bits;

__at(0x071F) __sfr AAD1CH1;
__at(0x071F) volatile __AAD1CH1bits_t AAD1CH1bits;

__at(0x071F) __sfr AD1CH1;
__at(0x071F) volatile __AD1CH1bits_t AD1CH1bits;
...
__at(0x079E) __sfr AAD2CH0;
__at(0x079E) volatile __AAD2CH0bits_t AAD2CH0bits;

__at(0x079E) __sfr AD2CH;

__at(0x079E) __sfr AD2CH0;
__at(0x079E) volatile __AD2CH0bits_t AD2CH0bits;

__at(0x079F) __sfr AAD2CH1;
__at(0x079F) volatile __AAD2CH1bits_t AAD2CH1bits;

__at(0x079F) __sfr AD2CH1;
__at(0x079F) volatile __AD2CH1bits_t AD2CH1bits;

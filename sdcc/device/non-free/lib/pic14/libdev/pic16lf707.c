...
__at(0x0097) __sfr T3CON;
__at(0x0097) volatile __T3CONbits_t T3CONbits;
...
__at(0x009A) __sfr TMR3;

__at(0x009A) __sfr TMR3L;

__at(0x009B) __sfr TMR3H;
...
__at(0x009E) __sfr T3GCON;
__at(0x009E) volatile __T3GCONbits_t T3GCONbits;

__at(0x009F) __sfr ADCON1;
__at(0x009F) volatile __ADCON1bits_t ADCON1bits;

__at(0x0105) __sfr TACON;
__at(0x0105) volatile __TACONbits_t TACONbits;

__at(0x0106) __sfr CPSBCON0;
__at(0x0106) volatile __CPSBCON0bits_t CPSBCON0bits;

__at(0x0107) __sfr CPSBCON1;
__at(0x0107) volatile __CPSBCON1bits_t CPSBCON1bits;

__at(0x0108) __sfr CPSACON0;
__at(0x0108) volatile __CPSACON0bits_t CPSACON0bits;

__at(0x0109) __sfr CPSACON1;
__at(0x0109) volatile __CPSACON1bits_t CPSACON1bits;
...
__at(0x0110) __sfr TMRA;

__at(0x0111) __sfr TBCON;
__at(0x0111) volatile __TBCONbits_t TBCONbits;

__at(0x0112) __sfr TMRB;

__at(0x0113) __sfr DACCON0;
__at(0x0113) volatile __DACCON0bits_t DACCON0bits;

__at(0x0114) __sfr DACCON1;
__at(0x0114) volatile __DACCON1bits_t DACCON1bits;

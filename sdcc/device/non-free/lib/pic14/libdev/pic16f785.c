...
volatile __PWMCLKbits_t __at(PWMCLK_ADDR) PWMCLKbits;
volatile __PWMCON0bits_t __at(PWMCON0_ADDR) PWMCON0bits;
volatile __PWMCON1bits_t __at(PWMCON1_ADDR) PWMCON1bits;
volatile __PWMPH1bits_t __at(PWMPH1_ADDR) PWMPH1bits;

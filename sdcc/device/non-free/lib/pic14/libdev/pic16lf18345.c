/*
 * This definitions of the PIC16LF18345 MCU.
 *
 * This file is part of the GNU PIC library for SDCC, originally
 * created by Molnar Karoly <molnarkaroly@users.sf.net> 2016.
 *
 * This file is generated automatically by the cinc2h.pl, 2016-01-09 15:09:22 UTC.
 *
...
__at(0x0219) volatile __SSP2BUFbits_t SSP2BUFbits;

__at(0x021A) __sfr SSP2ADD;
__at(0x021A) volatile __SSP2ADDbits_t SSP2ADDbits;

__at(0x021B) __sfr SSP2MSK;
__at(0x021B) volatile __SSP2MSKbits_t SSP2MSKbits;

__at(0x021C) __sfr SSP2STAT;
__at(0x021C) volatile __SSP2STATbits_t SSP2STATbits;

__at(0x021D) __sfr SSP2CON;
__at(0x021D) volatile __SSP2CONbits_t SSP2CONbits;
...
__at(0x0314) __sfr CCP3CAP;
__at(0x0314) volatile __CCP3CAPbits_t CCP3CAPbits;

__at(0x0315) __sfr CCPR4;

__at(0x0315) __sfr CCPR4L;

__at(0x0316) __sfr CCPR4H;

__at(0x0317) __sfr CCP4CON;
__at(0x0317) volatile __CCP4CONbits_t CCP4CONbits;

__at(0x0318) __sfr CCP4CAP;
__at(0x0318) volatile __CCP4CAPbits_t CCP4CAPbits;
...
__at(0x040D) __sfr CCDNB;
__at(0x040D) volatile __CCDNBbits_t CCDNBbits;

__at(0x040E) __sfr CCDNC;
__at(0x040E) volatile __CCDNCbits_t CCDNCbits;
...
__at(0x048D) __sfr CCDPB;
__at(0x048D) volatile __CCDPBbits_t CCDPBbits;

__at(0x048E) __sfr CCDPC;
__at(0x048E) volatile __CCDPCbits_t CCDPCbits;
...
__at(0x061F) __sfr PWMTMRS;
__at(0x061F) volatile __PWMTMRSbits_t PWMTMRSbits;
...
__at(0x0711) __sfr CWG2CLKCON;
__at(0x0711) volatile __CWG2CLKCONbits_t CWG2CLKCONbits;

__at(0x0712) __sfr CWG2DAT;
__at(0x0712) volatile __CWG2DATbits_t CWG2DATbits;

__at(0x0713) __sfr CWG2DBR;
__at(0x0713) volatile __CWG2DBRbits_t CWG2DBRbits;

__at(0x0714) __sfr CWG2DBF;
__at(0x0714) volatile __CWG2DBFbits_t CWG2DBFbits;

__at(0x0715) __sfr CWG2CON0;
__at(0x0715) volatile __CWG2CON0bits_t CWG2CON0bits;

__at(0x0716) __sfr CWG2CON1;
__at(0x0716) volatile __CWG2CON1bits_t CWG2CON1bits;

__at(0x0717) __sfr CWG2AS0;
__at(0x0717) volatile __CWG2AS0bits_t CWG2AS0bits;

__at(0x0718) __sfr CWG2AS1;
__at(0x0718) volatile __CWG2AS1bits_t CWG2AS1bits;

__at(0x0719) __sfr CWG2STR;
__at(0x0719) volatile __CWG2STRbits_t CWG2STRbits;
...
__at(0x0E16) __sfr CCP3PPS;
__at(0x0E16) volatile __CCP3PPSbits_t CCP3PPSbits;

__at(0x0E17) __sfr CCP4PPS;
__at(0x0E17) volatile __CCP4PPSbits_t CCP4PPSbits;

__at(0x0E18) __sfr CWG1PPS;
__at(0x0E18) volatile __CWG1PPSbits_t CWG1PPSbits;

__at(0x0E19) __sfr CWG2PPS;
__at(0x0E19) volatile __CWG2PPSbits_t CWG2PPSbits;
...
__at(0x0E1D) __sfr SSP2CLKPPS;
__at(0x0E1D) volatile __SSP2CLKPPSbits_t SSP2CLKPPSbits;

__at(0x0E1E) __sfr SSP2DATPPS;
__at(0x0E1E) volatile __SSP2DATPPSbits_t SSP2DATPPSbits;

__at(0x0E1F) __sfr SSP2SSPPS;
__at(0x0E1F) volatile __SSP2SSPPSbits_t SSP2SSPPSbits;
...
__at(0x0E2C) __sfr T3CKIPPS;

__at(0x0E2D) __sfr T3GPPS;

__at(0x0E2E) __sfr T5CKIPPS;

__at(0x0E2F) __sfr T5GPPS;

/*
 * This definitions of the PIC16LF747 MCU.
 *
...
__at(0x0095) __sfr CCPR3;

__at(0x0095) __sfr CCPR3L;

__at(0x0096) __sfr CCPR3H;

__at(0x0097) __sfr CCP3CON;
__at(0x0097) volatile __CCP3CONbits_t CCP3CONbits;
...
__at(0x009B) __sfr ADCON2;
__at(0x009B) volatile __ADCON2bits_t ADCON2bits;

__at(0x009C) __sfr CMCON;
__at(0x009C) volatile __CMCONbits_t CMCONbits;

__at(0x009D) __sfr CVRCON;
__at(0x009D) volatile __CVRCONbits_t CVRCONbits;

/* Register definitions for pic16f1827.
...
volatile __APFCON1_bits_t __at(APFCON1_ADDR) APFCON1_bits;
...
volatile __CCPTMRS_bits_t __at(CCPTMRS_ADDR) CCPTMRS_bits;
...
volatile __PIE4_bits_t __at(PIE4_ADDR) PIE4_bits;
...
volatile __PIR4_bits_t __at(PIR4_ADDR) PIR4_bits;
...
volatile __SSP2CON1_bits_t __at(SSP2CON1_ADDR) SSP2CON1_bits;
volatile __SSP2CON2_bits_t __at(SSP2CON2_ADDR) SSP2CON2_bits;
volatile __SSP2CON3_bits_t __at(SSP2CON3_ADDR) SSP2CON3_bits;
volatile __SSP2STAT_bits_t __at(SSP2STAT_ADDR) SSP2STAT_bits;

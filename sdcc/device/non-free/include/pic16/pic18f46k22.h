/*
 * pic18f46k22.h - device specific declarations
 *
...
extern __sfr __at (0xF3B) ANSELD;
typedef union {
        struct {
                unsigned ANSD0          : 1;
                unsigned ANSD1          : 1;
...
extern volatile __ANSELDbits_t __at (0xF3B) ANSELDbits;

extern __sfr __at (0xF3C) ANSELE;
typedef union {
        struct {
                unsigned ANSE0          : 1;
                unsigned ANSE1          : 1;
...
extern volatile __ANSELEbits_t __at (0xF3C) ANSELEbits;

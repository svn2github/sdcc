//
// Register Declarations for Microchip 16F1827 Processor
//
//
...
#define _MCLRE_OFF           0xFFBF    // RA5/MCLR/VPP pin function is digital input
#define _MCLRE_ON            0xFFFF    // RA5/MCLR/VPP pin function is MCLR
...
#define _VCAPEN_OFF          0xFFFF    // VCAP pin function is disabled
...
#define ANSB6                ANSELB_bits.ANSB6
#define ANSB7                ANSELB_bits.ANSB7
#endif /* NO_BIT_DEFINES */
...
#define P1CSEL               APFCON0_bits.P1CSEL
#define P1DSEL               APFCON0_bits.P1DSEL
#define CCP2SEL              APFCON0_bits.CCP2SEL
#define P2BSEL               APFCON0_bits.P2BSEL
...
extern volatile __APFCON1_bits_t __at(APFCON1_ADDR) APFCON1_bits;

#ifndef NO_BIT_DEFINES
#define TXCKSEL              APFCON1_bits.TXCKSEL
#endif /* NO_BIT_DEFINES */
...
extern volatile __CCPTMRS_bits_t __at(CCPTMRS_ADDR) CCPTMRS_bits;
...
extern volatile __PIE4_bits_t __at(PIE4_ADDR) PIE4_bits;

#ifndef NO_BIT_DEFINES
#define SSP2IE               PIE4_bits.SSP2IE
#define BCL2IE               PIE4_bits.BCL2IE
#endif /* NO_BIT_DEFINES */
...
extern volatile __PIR4_bits_t __at(PIR4_ADDR) PIR4_bits;

#ifndef NO_BIT_DEFINES
#define SSP2IF               PIR4_bits.SSP2IF
#define BCL2IF               PIR4_bits.BCL2IF
#endif /* NO_BIT_DEFINES */
...
extern volatile __SSP2CON1_bits_t __at(SSP2CON1_ADDR) SSP2CON1_bits;
...
extern volatile __SSP2CON2_bits_t __at(SSP2CON2_ADDR) SSP2CON2_bits;
...
extern volatile __SSP2CON3_bits_t __at(SSP2CON3_ADDR) SSP2CON3_bits;
...
extern volatile __SSP2STAT_bits_t __at(SSP2STAT_ADDR) SSP2STAT_bits;

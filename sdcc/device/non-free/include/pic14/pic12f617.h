//
// Register Declarations for Microchip 12F617 Processor
//
//
...
typedef union {
  struct {
    ...
    unsigned char DCB0:1;
    unsigned char DCB1:1;
    unsigned char :1;
    unsigned char P1M:1;
  };
} __CCP1CONbits_t;
...
typedef union {
  struct {
    unsigned char PMADRH0:1;
    unsigned char PMADRH1:1;
    unsigned char PMADRH2:1;
    unsigned char :1;
    unsigned char :1;
    unsigned char :1;
    unsigned char :1;
...
typedef union {
  struct {
    unsigned char PMADRL0:1;
    unsigned char PMADRL1:1;
    unsigned char PMADRL2:1;
    unsigned char PMADRL3:1;
    unsigned char PMADRL4:1;
    unsigned char PMADRL5:1;
    unsigned char PMADRL6:1;
    unsigned char PMADRL7:1;
  };
} __PMADRLbits_t;
extern volatile __PMADRLbits_t __at(PMADRL_ADDR) PMADRLbits;
...
typedef union {
  struct {
    unsigned char PMDATL0:1;
    unsigned char PMDATL1:1;
    unsigned char PMDATL2:1;
    unsigned char PMDATL3:1;
    unsigned char PMDATL4:1;
    unsigned char PMDATL5:1;
    unsigned char PMDATL6:1;
    unsigned char PMDATL7:1;
  };
} __PMDATLbits_t;
extern volatile __PMDATLbits_t __at(PMDATL_ADDR) PMDATLbits;
...
#define CCPIE                PIE1bits.CCPIE                 /* bit 5 */
...
#define CCPIF                PIR1bits.CCPIF                 /* bit 5 */
...
#define PMADRL_bits          PMADRLbits
#define PMCON1_bits          PMCON1bits
#define PMDATL_bits          PMDATLbits

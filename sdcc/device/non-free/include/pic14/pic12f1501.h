//
// Register Declarations for Microchip 12F1501 Processor
//
//
...
typedef union {
  struct {
    ...
    unsigned char :1;
    unsigned char :1;
    unsigned char CWG1ASEL:1;
    unsigned char CWG1BSEL:1;
  };
} __APFCONbits_t;
...
#define CWG1ASEL             APFCONbits.CWG1ASEL            /* bit 6 */
#define CWG1BSEL             APFCONbits.CWG1BSEL            /* bit 7 */

//
// Register Declarations for Microchip 16F1823 Processor
//
//
...
//       19 Jun 2012  Removed CCP1SEL and P1BSEL bits from "APFCON Bits".
//                    Removed CCP1SEL and P1BSEL bits from "APFCON0 Bits".
...
typedef union {
  ...
  struct {
    ...
    unsigned char C12IN0N:1;
    unsigned char C1OUT_PORTA:1;
    unsigned char :1;
    unsigned char SDO_PORTA:1;
    unsigned char OSC1:1;
    unsigned char :1;
    unsigned char :1;
  };
  struct {
    unsigned char TX_PORTA:1;
    unsigned char RX_PORTA:1;
  ...
  struct {
    unsigned char CK_PORTA:1;
    unsigned char DT_PORTA:1;
...
typedef union {
  ...
  struct {
    ...
    unsigned char C12IN1N:1;
    unsigned char C12IN2N:1;
    unsigned char C12IN3N:1;
  ...
  struct {
    ...
    unsigned char P1D:1;
    unsigned char P1C:1;
    unsigned char MDOUT_PORTC:1;
    unsigned char RX_PORTC:1;
    unsigned char :1;
    unsigned char :1;
  };
  struct {
    unsigned char SCK:1;
    unsigned char SDI:1;
    unsigned char SDO_PORTC:1;
    unsigned char NOT_SS:1;
    unsigned char TX_PORTC:1;
    unsigned char DT_PORTC:1;
    unsigned char :1;
    unsigned char :1;
  };
  struct {
...
#define CK_PORTA             PORTAbits.CK_PORTA             /* bit 0 */
#define CPS0                 PORTAbits.CPS0                 /* bit 0 */
#define DACOUT               PORTAbits.DACOUT               /* bit 0 */
#define RA0                  PORTAbits.RA0                  /* bit 0 */
#define TX_PORTA             PORTAbits.TX_PORTA             /* bit 0 */
#define AN1                  PORTAbits.AN1                  /* bit 1 */
#define C12IN0N              PORTAbits.C12IN0N              /* bit 1 */
#define CPS1                 PORTAbits.CPS1                 /* bit 1 */
#define DT_PORTA             PORTAbits.DT_PORTA             /* bit 1 */
#define RA1                  PORTAbits.RA1                  /* bit 1 */
#define RX_PORTA             PORTAbits.RX_PORTA             /* bit 1 */
...
#define NOT_SS               PORTAbits.NOT_SS               /* bit 3, shadows bit in PORTCbits */
...
#define SDO_PORTA            PORTAbits.SDO_PORTA            /* bit 4 */
...
#define AN4                  PORTCbits.AN4                  /* bit 0 */
#define C2INP                PORTCbits.C2INP                /* bit 0 */
#define CPS4                 PORTCbits.CPS4                 /* bit 0 */
#define RC0                  PORTCbits.RC0                  /* bit 0 */
#define SCK                  PORTCbits.SCK                  /* bit 0 */
#define SCL                  PORTCbits.SCL                  /* bit 0 */
#define AN5                  PORTCbits.AN5                  /* bit 1 */
#define C12IN1N              PORTCbits.C12IN1N              /* bit 1 */
#define CPS5                 PORTCbits.CPS5                 /* bit 1 */
#define RC1                  PORTCbits.RC1                  /* bit 1 */
#define SDA                  PORTCbits.SDA                  /* bit 1 */
#define SDI                  PORTCbits.SDI                  /* bit 1 */
#define AN6                  PORTCbits.AN6                  /* bit 2 */
#define C12IN2N              PORTCbits.C12IN2N              /* bit 2 */
#define CPS6                 PORTCbits.CPS6                 /* bit 2 */
#define MDCIN1               PORTCbits.MDCIN1               /* bit 2 */
#define P1D                  PORTCbits.P1D                  /* bit 2 */
#define RC2                  PORTCbits.RC2                  /* bit 2 */
#define SDO_PORTC            PORTCbits.SDO_PORTC            /* bit 2 */
#define AN7                  PORTCbits.AN7                  /* bit 3 */
#define C12IN3N              PORTCbits.C12IN3N              /* bit 3 */
#define CPS7                 PORTCbits.CPS7                 /* bit 3 */
#define MDMIN                PORTCbits.MDMIN                /* bit 3 */
#define P1C                  PORTCbits.P1C                  /* bit 3 */
#define RC3                  PORTCbits.RC3                  /* bit 3 */
#define C2OUT_PORTC          PORTCbits.C2OUT_PORTC          /* bit 4 */
#define CK_PORTC             PORTCbits.CK_PORTC             /* bit 4 */
#define MDOUT_PORTC          PORTCbits.MDOUT_PORTC          /* bit 4 */
#define P1B                  PORTCbits.P1B                  /* bit 4 */
#define RC4                  PORTCbits.RC4                  /* bit 4 */
#define SRNQ                 PORTCbits.SRNQ                 /* bit 4 */
#define TX_PORTC             PORTCbits.TX_PORTC             /* bit 4 */
#define CCP1                 PORTCbits.CCP1                 /* bit 5 */
#define DT_PORTC             PORTCbits.DT_PORTC             /* bit 5 */
#define MDCIN2               PORTCbits.MDCIN2               /* bit 5 */
#define P1A                  PORTCbits.P1A                  /* bit 5 */
#define RC5                  PORTCbits.RC5                  /* bit 5 */
#define RX_PORTC             PORTCbits.RX_PORTC             /* bit 5 */

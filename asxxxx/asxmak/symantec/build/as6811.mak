...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\AS6811\m6811.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\M11ADR.OBJ  $(OUTPUTDIR)\M11EXT.OBJ  $(OUTPUTDIR)\M11MCH.OBJ  \
		 $(OUTPUTDIR)\M11PST.OBJ 
...
$(OUTPUTDIR)\M11EXT.OBJ:	..\..\..\AS6811\M11EXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\M11EXT.obj ..\..\..\AS6811\M11EXT.C
